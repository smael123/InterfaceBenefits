...
Vendor[] vendors = [
    new Vendor { TaxId = "123456789", BusinessName = "Bender's Stjolen Car Parts", IsCompliance = true },
    new Vendor { TaxId = "453451234", BusinessName = "Fry's Schjool of Hard Rock", IsCompliance = false },
    new Vendor { TaxId = "123456789", BusinessName = "Bender's Orphanage", IsCompliance = false },
];

Censorer.CensorData(vendors);
...
Customer[] customers = [
    ...
    new Customer { SocialSecurityNumber = "111223333", FirstName = "Padme", LastName = "Awmidala", IsHomeless = false }
];

Censorer.CensorData(customers);
